...
- [pub](facility_type)
- find me a nearby [pub](facility_type) my zip code is [060029](location)
...
- my zip code is [010032](location) and i need a [pub](facility_type)
- i need a [cafe](facility_type) at [011791](location)
- i need a [restaurant](facility_type) at [011791](location)
- i need a [pub](facility_type) at [011791](location)
...
- i am in [Lujerului](location) and i need a [pub](facility_type)
- i need a [cafe](facility_type) in [Muncii](location)
- i need a [restaurant](facility_type) in [Gorjului](location)
- i need a [pub](facility_type) in [Obor](location)
